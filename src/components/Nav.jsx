...
function Nav() {
  ...
  return (
    <nav className="w-full bg-blue-900 p-4 text-white mr-4">
      <div className="flex items-center justify-between">
        ...
        <ul className={`md:flex hidden space-x-4`}>
          ...
          {/* <li><Link to="/interface" className="font-bold">Interface</Link></li> */}
          <li><Link to="/tutorial" className="font-bold">Tutorial</Link></li>
          {/* <li><Link to="/support" className="font-bold">Support</Link></li> */}
          <li><Link to='/users' className='font-bold'>Account</Link></li>
          <li><Link to="/sign-in" className="font-bold">Sign In</Link></li>
          
          <li>
            <details className="group">
              <summary className="cursor-pointer mr-6"><i className="fas fa-user"></i></summary>
        ...
        {isMenuOpen && (
          <ul className="flex flex-col md:hidden absolute bg-blue-900 w-full left-0 top-[58px]">
            ...
            {/* <li><Link to="/interface" onClick={() => setIsMenuOpen(false)} className="block p-2 text-base font-bold">Interface</Link></li> */}
            ...
            <li><Link to='/users' onClick={() => setIsMenuOpen(false)} className='text-white text-base font-bold'>Users</Link></li>
